...
title('rand: x = U(0,1)'); grid on; xlabel('sample'); ylabel('x'); hold on;
plot(xval, e, '-r', 'linewidth', 2);
plot(xval, s, '-', 'color', c.darkred, 'linewidth', 2);
legend('rand realisations', 'sample mean', 'sample standard deviation');
...
plot(0, 0, 'ow');
plot(0, 0.7, 'ow');
legend('sample st deviation','theoretical st deviation'); xlabel('realisation'); ylabel('standard deviation')
